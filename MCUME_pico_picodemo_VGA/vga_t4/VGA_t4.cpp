...
{
  printf("VGA_t4.cpp: about to execute begin\n");
  printf("VGA_t4.cpp: mode = %d:",mode);
  
  switch(mode) {
    case VGA_MODE_320x240:
      printf("VGA_t4.cpp: we should be inside VGA_MODE_320x240\n");
  ...
  printf("VGA_t4.cpp: about to execute init_pio_framebuffer\n");
  ...
  printf("VGA_t4.cpp: about to execute multicore_launch_core1\n");
...
void VGA_T4::clear(vga_pixel color) {
  ...
  printf("VGA_t4.cpp: about to execute clear\n");
  int i,j;
...
void VGA_T4::drawRect(int16_t x, int16_t y, int16_t w, int16_t h, vga_pixel color) {
  printf("VGA_t4.cpp: about to execute drawRect\n");
...
void VGA_T4::drawText(int16_t x, int16_t y, const char * text, vga_pixel fgcolor, vga_pixel bgcolor, bool doublesize) {
  vga_pixel c;
  vga_pixel * dst;
  //this gets called repeatedly by tstvga.cpp, so best not output here
//    printf("VGA_t4.cpp: about to execute drawText\n");
...
void VGA_T4::begin_gfxengine(int nblayers, int nbtiles, int nbsprites)
{
  ...
  printf("VGA_t4.cpp: about to execute being_gfxengine\n");
...
void VGA_T4::run_gfxengine()
{
  ...
  printf("VGA_t4.cpp: about to execute run_gfxengine\n");
